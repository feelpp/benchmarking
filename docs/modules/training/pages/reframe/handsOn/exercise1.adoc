...
- `-o`: the output file to write the sequence. It will be saved in CSV format (`elapsed,fibonacci_number`)

!!!=========TODO============
TODO: Make sure app is availabe, otherwise provide it in a source code block
