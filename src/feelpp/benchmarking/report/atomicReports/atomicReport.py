...
class AtomicReport:
    ...
    """
    def __init__(self, application_id, machine_id, reframe_report_json, plot_config_json,parametrized_partials_dir):
        ...
        Args:
            ...
            parametrized_partials_dir (str): The directory path where parametric descriptions of the use case can be found (usually comes with the reframe report). Pass None if non-existent
        """
        data = self.parseJson(reframe_report_json)
        self.plots_config = self.parseJson(plot_config_json)
        self.parametrized_partials_dir = parametrized_partials_dir
    ...
    def movePartials(self,base_dir):
        ...
        """
        if not self.parametrized_partials_dir:
            return
        ...
        for description_filename in os.listdir(self.parametrized_partials_dir):
