...
def main_cli():
    ...
    parser.add_argument( '-f', '--output-format', type=str, default='adoc', choices=['adoc','tex'], help='The format of the final document to be generated. Currently supports: adoc.' )
